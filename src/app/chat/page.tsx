    ...
    <ProtectedLayout>
                ...
                {TEMPLATES.map((tpl) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex flex-col items-start gap-2 rounded-lg border border-border bg-card p-4 text-left transition-all hover:border-primary/30 hover:bg-primary/5"
                    >
            ...
            <div className="mx-auto max-w-3xl space-y-6 p-4">
                ...
                >
                  ...
                  >
                    {msg.role === 'user' ? (
                      ...
                      <Bot className="h-4 w-4 text-accent-pink" />
                    )}
                  </div>
                  <div
                    className={cn(
                      'min-w-0 flex-1 rounded-2xl px-4 py-3 text-sm leading-relaxed',
                      msg.role === 'user'
              ...
              {loading && (
                <div className="flex gap-3">
                  <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-accent-pink/10">
                    <Bot className="h-4 w-4 text-accent-pink" />
                  </div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 rounded-lg bg-muted px-3 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-muted/80"
                  >
                ...
                <div className="flex items-end gap-2 rounded-2xl border border-border bg-background p-2">
                  <textarea
                    ...
                    className="min-h-[40px] flex-1 resize-none border-0 bg-transparent px-2 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none disabled:opacity-50"
                  />
                  <button
                    onClick={handleSend}
                    disabled={!input.trim() || !activeConversationId || loading}
                    className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-primary text-primary-foreground transition-all hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                  >
      ...
      {showTemplateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-2xl rounded-xl bg-card p-6 shadow-dialog mx-4 max-h-[90vh] overflow-y-auto">
            {/* 模板选择阶段 */}
            {!activeTemplate ? (
              <>
                  ...
                  {TEMPLATES.map((tpl) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex flex-col items-start gap-2 rounded-lg border border-border bg-background p-4 text-left transition-all hover:border-primary/30 hover:bg-primary/5"
                      >
                        <Icon className="h-5 w-5 text-primary" />
                        <div>
                          <p className="text-sm font-semibold text-foreground">{tpl.name}</p>
